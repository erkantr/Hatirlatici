...
public class ReminderBroadcast2 extends BroadcastReceiver {
    ...
    TextView hadis1;
    public static String bildirim_baslik,bildirim_mesaj;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "bysoftware2")
                .setSmallIcon(R.drawable.logoo1)
                .setContentTitle(baslik_text)
                .setContentText(mesaj_text)
                .setAutoCancel(true)
        ...
        TextView dialog_baslik = view.findViewById(R.id.dialog_baslik);
        dialog_baslik.setText(baslik_text);
        hadisleriAl();
